...
# names(MPI_int) = paste(names(MPI_int), "_agg", sep="")
...
# Plot de atributo 
plot(MPI_int$Intensity.of.Deprivation.Urban, main = "Plot de Intensity of deprivation rural", xlab="índice del valor", ylab="valor")
...
BINS_EQ.F = 5
BINS_EQ.W = 5
atributo = MPI_int$Intensity.of.Deprivation.Urban
